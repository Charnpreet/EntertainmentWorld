...
import UIKit
class Constants{
    static  let MOVIE_CATEGORIES = ["Popular", "Now Playing", "Up Coming"]
    static let NO_OF_SECTIONS_IN_TABLE_HEADER = 3
    ...
    static let DARK_MODE_UI_LABEL_FRAME = CGRect(x: 10, y: Constants.IOS_SCREEN_HEIGHT/2, width: Constants.IOS_SCREEN_WIDTH-20, height: 50)
    static let DARK_MODE_SWITCH_FRAME = CGRect(x: 350, y: Constants.IOS_SCREEN_HEIGHT/1.95, width: 200, height: 30)
